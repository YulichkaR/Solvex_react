  ...
  const RestaurantCards = [
    {
      ...
      cardDescription:
        "Тут гості зможуть поснідати, пообідати чи повечеряти насолоджуючись більш ніж 200-ми видами страв середземноморської та національної кухні. Унікальна колекція найкращих вин Італії, Франції, Чилі, Грузії та України доповнить кулінарну нотувитонченим смаком.",
    ...
    },
    {
      ...
      cardDescription:
        "Естетика в кожній лінії інтер'єру, поєднання кольорів, історичного минулого кондитерської аптеки додає закладу особливої атмосферию Цінні експонати інтерактивного музею – це відреставровані меблі і оригінальні постери. Смачне лікує! Sapidum Curat!",
      workTime: "🥗 Restaurant:  ⏱08:00–22:00",
